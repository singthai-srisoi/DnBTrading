...
import { authPermission, authUserUserPermissions, authUser, productsProducttype, productsProduct, authGroup, authUserGroups, djangoContentType, djangoAdminLog, tokenBlacklistOutstandingtoken, tokenBlacklistBlacklistedtoken, authGroupPermissions, inventoriesInventory, vehiclesVehicle, personPerson } from "./schema";
