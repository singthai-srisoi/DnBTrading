...
CREATE TABLE "inventories_inventory" (
	...
	CONSTRAINT "inventories_inventory_ticket_no_4343be3a_uniq" UNIQUE("ticket_no")
);
--> statement-breakpoint
...
ALTER TABLE "products_product" ADD CONSTRAINT "products_product_type_id_027d8fc4_fk_products_producttype_code" FOREIGN KEY ("type_id") REFERENCES "public"."products_producttype"("code") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "token_blacklist_outstandingtoken" ADD CONSTRAINT "token_blacklist_outs_user_id_83bc629a_fk_auth_user" FOREIGN KEY ("user_id") REFERENCES "public"."auth_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "inventories_inventory" ADD CONSTRAINT "inventories_inventor_product_id_8199cb3d_fk_products_" FOREIGN KEY ("product_id") REFERENCES "public"."products_product"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "inventories_inventory" ADD CONSTRAINT "inventories_inventor_vehicle_id_8686ba5c_fk_vehicles_" FOREIGN KEY ("vehicle_id") REFERENCES "public"."vehicles_vehicle"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "inventories_inventory" ADD CONSTRAINT "inventories_inventory_customer_id_6e232f4f_fk_person_person_id" FOREIGN KEY ("customer_id") REFERENCES "public"."person_person"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "inventories_inventory" ADD CONSTRAINT "inventories_inventory_driver_id_440b3e60_fk_person_person_id" FOREIGN KEY ("driver_id") REFERENCES "public"."person_person"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "inventories_inventory" ADD CONSTRAINT "inventories_inventory_supplier_id_c1910ce3_fk_person_person_id" FOREIGN KEY ("supplier_id") REFERENCES "public"."person_person"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "products_product_type_id_027d8fc4" ON "products_product" USING btree ("type_id" text_ops);--> statement-breakpoint
CREATE INDEX "products_product_type_id_027d8fc4_like" ON "products_product" USING btree ("type_id" varchar_pattern_ops);--> statement-breakpoint
...
CREATE INDEX "products_producttype_code_f1627f17_like" ON "products_producttype" USING btree ("code" varchar_pattern_ops);--> statement-breakpoint
...
CREATE INDEX "token_blacklist_outstandingtoken_user_id_83bc629a" ON "token_blacklist_outstandingtoken" USING btree ("user_id" int4_ops);--> statement-breakpoint
...
CREATE INDEX "inventories_inventory_customer_id_6e232f4f" ON "inventories_inventory" USING btree ("customer_id" int8_ops);--> statement-breakpoint
CREATE INDEX "inventories_inventory_driver_id_440b3e60" ON "inventories_inventory" USING btree ("driver_id" int8_ops);--> statement-breakpoint
CREATE INDEX "inventories_inventory_product_id_8199cb3d" ON "inventories_inventory" USING btree ("product_id" int8_ops);--> statement-breakpoint
CREATE INDEX "inventories_inventory_supplier_id_c1910ce3" ON "inventories_inventory" USING btree ("supplier_id" int8_ops);--> statement-breakpoint
CREATE INDEX "inventories_inventory_ticket_no_4343be3a_like" ON "inventories_inventory" USING btree ("ticket_no" varchar_pattern_ops);--> statement-breakpoint
CREATE INDEX "inventories_inventory_vehicle_id_8686ba5c" ON "inventories_inventory" USING btree ("vehicle_id" int8_ops);
*/